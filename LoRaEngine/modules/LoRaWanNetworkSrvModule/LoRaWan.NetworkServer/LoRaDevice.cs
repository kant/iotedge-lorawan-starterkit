...
namespace LoRaWan.NetworkServer
{
    ...
    public sealed class LoRaDevice : IDisposable, ILoRaDeviceRequestQueue
    {
        ...
        internal void SetRequestHandler(LoRaDataRequestHandlerImplementation dataRequestHandler) => this.dataRequestHandler = dataRequestHandler;
        ...
        readonly Queue<LoRaRequest> queuedRequests = new Queue<LoRaRequest>();
        volatile LoRaRequest runningRequest;
        private LoRaDataRequestHandlerImplementation dataRequestHandler;

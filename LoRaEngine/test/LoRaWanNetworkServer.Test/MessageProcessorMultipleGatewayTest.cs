...
namespace LoRaWan.NetworkServer.Test
{
    ...
    public class MessageProcessorMultipleGatewayTest : MessageProcessorTestBase
    {
        ...
        private LoRaDataRequestHandlerImplementation secondRequestHandlerImplementation;
        ...
        public MessageProcessorMultipleGatewayTest()
        {
            ...
            this.secondRequestHandlerImplementation = new LoRaDataRequestHandlerImplementation(this.SecondServerConfiguration, this.SecondFrameCounterUpdateStrategyFactory, new LoRaPayloadDecoder());
